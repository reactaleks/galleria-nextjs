...
export default function Page({ params }: { params: { slug: string } }) {
  ...
  return (
    <motion.div
      ...
      className="w-full min-h-[90vh] pt-6  md:flex md:flex-col md:justify-between overflow-x-hidden"
    >
        ...
        <div className="relative xl:w-[50vw]">
          ...
          <div className="absolute -bottom-16 md:left-64 md:-top-1 ">
            <motion.div
              ...
              transition={{ duration: 1 }}
              className="w-[280px] h-[133px] md:w-[445px] md:h-[302px] flex flex-col bg-white justify-center md:justify-start md:items-start md:p-12 "
            >
              <div className="text-[24px] md:text-[56px] md:leading-[64px] font-bold text-gray-main md:text-[#000000]">
                {pageData?.name}
              </div>
              <div className="text-[15x] text-gray-main md:text-left">
