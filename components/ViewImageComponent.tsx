...
export default function ViewImage() {
  ...
  return (
    <div
      ...
      className="w-[152px] h-[40px] bg-black text-white flex items-center justify-around bg-opacity-75 absolute top-0"
    >
      ...
      <div className="uppercase font-bold text-[10px] tracking-[2.14px]">view image</div>
    </div>
  );
}
